            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
              {personas.map((p) => (
                <div
                  ...
                  className={cn(
                    "cursor-pointer rounded-xl border-2 p-3 sm:p-4 transition-all hover:border-primary/50",
                ...
                >
                  <div className="flex flex-col gap-1">
                    ...
                    <p className="text-xs text-muted-foreground mt-1 sm:mt-2">{p.description}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <Card className="border-border bg-card shadow-sm">
          ...
          <CardContent className="space-y-4 p-4 sm:p-6">
            <div className="space-y-2">
              <Label htmlFor="goal" className="text-sm">あなたの目標は何ですか？</Label>
              <Input
                id="goal"
            ...
            <div className="space-y-2">
              <Label htmlFor="reason" className="text-sm">オナ禁を始めた理由は何ですか？</Label>
              <Textarea
                id="reason"
            ...
            <div className="space-y-2">
              <Label htmlFor="failTriggers" className="text-sm">過去の失敗要因やトリガーは何ですか？</Label>
              <Textarea
                id="failTriggers"
          ...
          <CardFooter className="flex justify-end border-t border-border pt-4 sm:pt-6 p-4 sm:p-6">
            <Button type="submit" disabled={loading} className="w-full sm:w-auto h-10 sm:h-11 text-sm sm:text-base">
              {loading ? "更新中..." : "設定を保存する"}
            </Button>
          </CardFooter>
        </Card>
